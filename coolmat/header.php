...
<head>
	...
	<!--here we use the template_url code and then join our location
	css file at the end  -->
...
<!-- this is our inner element that takes up the full page with -->
	<header id="masthead" class="site-header">

<!-- this is our inner element that takes up 1380px-->
	<div class="header-inner container">
	<div class="site-branding">
	<!-- here we link to our logo from our assets folder -->
